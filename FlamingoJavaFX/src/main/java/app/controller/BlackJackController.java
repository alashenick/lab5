...
public class BlackJackController implements Initializable {
	...
	public void btnHit_Click(ActionEvent event) {
		...
		patTMoveRot.getChildren().addAll(scaleT, rotT, transT);
		patTMoveRot2.getChildren().addAll(scaleT2);
	...
	private PathTransition CreatePathTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
		...
		path.getElements().add(new CubicCurveTo(toPoint.getX() * 1, toPoint.getY() * 1, toPoint.getX() / 1,
				toPoint.getY() / 1, toPoint.getX(), toPoint.getY()));
